# fc97ee1d-ba3 m9 Bd3 — residual LOW #4

**Variant:** `why_user_reply`
**Position (FEN):** `r1bqkbnr/p2p3p/n1p2p2/1p1Pp1p1/2B1P3/2P2N1P/PP3PP1/RNBQK2R w KQkq - 0 9`
**Move played:** `Bd3` (cp_loss `106`)
**Engine's best (stored):** `Nxe5`
**User color:** white

## Caption as shipped

> Bd3 is a mistake. Nxe5 was better. Opponent's strongest reply: Nh6.

## Live engine view (depth 15, multipv 3)

  #1 eval(W) `+314cp`  PV: `Nxe5 h5 Ng6 Rh6 Bb3 Bd6`
  #2 eval(W) `+296cp`  PV: `Nxg5 h5 Be2 fxg5 Bxh5+ Ke7`
  #3 eval(W) `+205cp`  PV: `Be2 Nh6 h4 g4 Nh2 Nf7`

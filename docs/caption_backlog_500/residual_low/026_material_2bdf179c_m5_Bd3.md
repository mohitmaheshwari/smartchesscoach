# 2bdf179c-78b m5 Bd3 — residual LOW #26

**Variant:** `why_user_missed_material`
**Position (FEN):** `rnbqkb1r/ppp2ppp/3p1n2/8/3PPp2/5N2/PPP3PP/RNBQKB1R w KQkq - 1 5`
**Move played:** `Bd3` (cp_loss `102`)
**Engine's best (stored):** `Nc3`
**User color:** white

## Caption as shipped

> Bd3 is a mistake. Nc3 was better. Nc3 wins material in the resulting line.

## Live engine view (depth 15, multipv 3)

  #1 eval(W) `+59cp`  PV: `Nc3 Nh5 Be2 h6 Qd3 g6`
  #2 eval(W) `+35cp`  PV: `Qe2 d5 Nc3 Be7 Nxd5 Nxd5`
  #3 eval(W) `+23cp`  PV: `Bxf4 Nxe4 Bd3 d5 O-O Bd6`

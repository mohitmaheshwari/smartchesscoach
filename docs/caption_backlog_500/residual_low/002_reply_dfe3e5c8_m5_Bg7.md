# dfe3e5c8-927 m5 Bg7 — residual LOW #2

**Variant:** `why_user_reply`
**Position (FEN):** `r1bqkbnr/pp1ppp1p/2n3p1/8/3PPP2/8/PP4PP/RNBQKBNR b KQkq - 0 5`
**Move played:** `Bg7` (cp_loss `114`)
**Engine's best (stored):** `d5`
**User color:** black

## Caption as shipped

> Bg7 is a mistake. d5 was better. Opponent's strongest reply: d5.

## Live engine view (depth 15, multipv 3)

  #1 eval(W) `-20cp`  PV: `d5 e5 h5 Be3 Bf5 Nf3`
  #2 eval(W) `+57cp`  PV: `Bg7 d5 Nd4 Nc3 Qb6 Nge2`
  #3 eval(W) `+85cp`  PV: `d6 d5 Nb8 Nc3 Bg7 Be3`

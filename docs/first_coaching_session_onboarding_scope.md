...
Status: APPROVED by Mohit on 2026-09-18. Implementation is staged; this is not a completion claim.
Amendment approved on 2026-09-19: puzzle-led discovery comes before assigning a lesson. Preserve the existing adaptive diagnostic; do not assign a fixed starter lesson or infer understanding from a correct move. Teach only when the encounter supplies evidence that help is useful, and keep all findings provisional.
Date: 2026-09-18.

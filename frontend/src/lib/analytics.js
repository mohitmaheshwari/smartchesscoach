...
export const ANALYTICS_EVENTS = Object.freeze({
  ...
  GAME_REVIEW_PRESCRIPTION_SERVED: "game_review_prescription_served",
  GAME_REVIEW_PRESCRIPTION_STARTED: "game_review_prescription_started",
  GAME_REVIEW_PRESCRIPTION_RESUMED: "game_review_prescription_resumed",
  GAME_REVIEW_PRESCRIPTION_DISMISSED: "game_review_prescription_dismissed",
  GAME_REVIEW_PRESCRIPTION_COMPLETED: "game_review_prescription_completed",
  GAME_REVIEW_NO_ELIGIBLE_GAME: "game_review_no_eligible_game",
  GAME_REVIEW_FALLBACK_OFFERED: "game_review_fallback_offered",
  GAME_REVIEW_NEXT_PRESCRIPTION_SERVED: "game_review_next_prescription_served",

...
const COACH_ENCOURAGEMENTS = {
  reflection_submitted: [
    "Reflecting like this is what separates plateau players from improving ones.",
    "Solid reflection. That's how you start spotting the same pattern next time.",
    "Right mindset — naming the mistake is half of fixing it.",
    "Awareness is the work. This kind of reflection compounds.",
    "This one will stick with you next game.",
  ],
  game_complete: [
    "Reflected on every key moment in this game.",
    "Game review complete. Future-you will benefit from this.",
    "Each reflection makes the next game sharper.",
    "This is how real improvement happens — one game at a time.",
    "Done with this game. Your patterns are getting clearer.",
  ],
  all_done: [
    "All games reviewed. That's the full sweep.",
    "Reflections done. Time to play.",
    "Caught up. Now go play with the patterns you found.",
    "Every loss turned into a lesson. That's the whole point.",
  ],
  quick_reflection: [
    "Quick and clear — that's the way.",
    "Efficient. You already know the pattern.",
    "Sharp.",
  ],
  deep_reflection: [

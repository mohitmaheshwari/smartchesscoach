...
**Positional (softer, Codex-assisted):** 6 `calculation_depth` · 7
...
- **Positional categories:** gold is Codex judgment → measure + improve worst
...
- **Codex terminal gateway** (`host.docker.internal:8000`) ONLY for the ambiguous
...
- **Verify-or-redo:** engine-confirm Codex's pick where checkable (don't accept
...
- Hand-label 15 moves; confirm the engine-hard pinner + Codex fallback agree with
...
- Categories/taxonomy: AGENTS.md "Cognitive Gap Types". Backfill existing games via

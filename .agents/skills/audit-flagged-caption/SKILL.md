...
Built 2026-06-03 after Codex hallucinated a verdict on `fb_3280cebef2e5` (FEN `1kr3r1/1p3p1p/p5b1/6Q1/8/2P5/PP4PP/2K1R2R b - - 2 25`, move 25...Be4). The bishop on g6 was screening Qg5 from Rg8. When the bishop left, the discovered attack opened — the caption said "Be4 loses to Qf4+" (correct, the zwischenzug saves the queen AND keeps Re1 attacking the bishop). Codex said the caption was wrong because the bishop "just hangs to Rxe4" — but Rxe4 loses to Rxg5 winning the queen, so it's white that's wrong without the in-between.
...
### 2. Walk the ORIGIN square (the key step Codex skipped on the Be4 case)

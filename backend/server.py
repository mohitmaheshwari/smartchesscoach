...
app = FastAPI(
    ...
    openapi_tags=[
        ...
        {
            "name": "Platforms",
            "description": "Chess platform integration (Chess.com, Lichess)"
        },
        {
            "name": "Games",
            "description": "Game import, retrieval, and management"
        },
        {
            "name": "Analysis",
            "description": "Game analysis with Stockfish and AI coaching"
        },
        {
            "name": "Voice",
            "description": "Text-to-speech coaching feedback"
        },
        {
            "name": "Journey",
            "description": "Player progression tracking and comprehensive dashboard"
        }
    ]
)
...
async def get_current_user(request: Request) -> User:
    ...
    print(f"[AUTH] Referer header: {request.headers.get('referer')}")
    print(f"[AUTH] Cookie header raw: {request.headers.get('cookie')}")
    print(f"[AUTH] Cookies parsed: {list(request.cookies.keys())}")
    print(f"[AUTH] All cookies dict: {dict(request.cookies)}")
...
# ==================== AUTH ROUTES ====================
# Auth endpoints are served from backend/routes/auth.py.

# ==================== PLATFORM CONNECTION ROUTES ====================

@api_router.post("/connect-platform", tags=["Platforms"])
...
@api_router.post("/import-games", tags=["Games"])
...
@api_router.get("/analysis/{game_id}", tags=["Analysis"])
...
# CORS Configuration - MUST allow credentials with specific origin

...
def test_lesson_result_rehydration_rejects_forged_state():
    ...
    assert LessonResult.from_event_dict(payload).event_dict() == payload
...
def test_caption_only_application_cannot_reach_used_in_games_in_shadow():

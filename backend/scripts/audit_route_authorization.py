...
PUBLIC_ROUTES: dict[str, str] = {
    ...
    # ---- Reference content and auth entry points, reviewed 2026-09-07 ----
    "GET /api/auth/google/login": "authentication entry point; establishes or completes a session",
    "GET /api/auth/status": "authentication entry point; establishes or completes a session",
    "GET /api/billing/config": "returns only plan price and whether payments are wired; no secrets",
    "GET /api/coach/modules/all": "static chess reference content; identical for every visitor",
    "GET /api/coach/principles-catalog": "static chess reference content; identical for every visitor",
    "GET /api/coach/theory/endgames": "static chess reference content; identical for every visitor",
    "GET /api/coach/theory/openings": "static chess reference content; identical for every visitor",
    "GET /api/coach/theory/rules": "static chess reference content; identical for every visitor",
    "GET /api/coach/theory/stats": "static chess reference content; identical for every visitor",
    "GET /api/coach/theory/tactical": "static chess reference content; identical for every visitor",
    "GET /api/community/puzzles": "aggregate community counts; no user identities",
    "GET /api/community/stats": "aggregate community counts; no user identities",
    "GET /api/endgames/categories": "endgame lesson reference content; identical for every visitor",
    "GET /api/endgames/lesson/{category_key}/{lesson_key}": "endgame lesson reference content; identical for every visitor",
    "GET /api/gamification/achievement-definitions": "static definitions (levels, XP, achievements); no user data",
    "GET /api/gamification/levels": "static definitions (levels, XP, achievements); no user data",
    "GET /api/gamification/xp-rewards": "static definitions (levels, XP, achievements); no user data",
    "GET /api/oauth/lichess/callback": "authentication entry point; establishes or completes a session",
    "GET /api/opening/resolve/{opening_name}": "opening library reference content; identical for every visitor",
    "GET /api/opening/variations/{base_opening}": "opening library reference content; identical for every visitor",
    "GET /api/openings/library": "opening library reference content; identical for every visitor",
    "GET /api/openings/match": "opening library reference content; identical for every visitor",
    "GET /api/principles/opening": "static chess reference content; identical for every visitor",
    "GET /api/public/openings": "public SEO content; deliberately crawlable",
    "GET /api/public/openings/{slug}": "public SEO content; deliberately crawlable",
    "GET /api/streak/focus-types": "static list of focus types; no user data",
    "GET /api/training/community-count": "aggregate community counts; no user identities",
    "GET /api/training/layer-info": "static taxonomy; no user data",
    "GET /api/training/lichess/opening": "proxied public Lichess opening data; no user data",
    "GET /api/training/lichess/search": "proxied public Lichess opening data; no user data",
    "GET /api/training/lichess/variations": "proxied public Lichess opening data; no user data",
    "GET /api/training/openings-database": "opening library reference content; identical for every visitor",
    "GET /api/training/tricks": "trap library reference content; identical for every visitor",
    "GET /api/training/tricks/categories": "trap library reference content; identical for every visitor",
    "GET /api/training/tricks/difficulty/{difficulty}": "trap library reference content; identical for every visitor",
    "GET /api/training/tricks/global-stats": "trap library reference content; identical for every visitor",
    "GET /api/training/tricks/opening/{opening_name}": "trap library reference content; identical for every visitor",
    "GET /api/training/tricks/{trap_key}": "trap library reference content; identical for every visitor",
    "GET /api/training/tricks/{trap_key}/practice": "trap library reference content; identical for every visitor",
    "GET /api/traps/checkmates": "trap library reference content; identical for every visitor",
    "GET /api/traps/difficulty/{difficulty}": "trap library reference content; identical for every visitor",
    "GET /api/traps/statistics": "trap library reference content; identical for every visitor",
    "GET /api/weakness-categories": "static taxonomy; no user data",
    "POST /api/auth/demo-login": "authentication entry point; establishes or completes a session",
    "POST /api/auth/google/mobile": "authentication entry point; establishes or completes a session",
    "POST /api/auth/session": "authentication entry point; establishes or completes a session",
    "POST /api/training/tricks/validate-avoidance": "trap library reference content; identical for every visitor",
    "POST /api/training/tricks/validate-recognition": "trap library reference content; identical for every visitor",
    "POST /api/traps/suggest": "trap library reference content; identical for every visitor",
}

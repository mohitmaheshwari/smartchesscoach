...
def _classify_tier(variant_key: str, file_name: str) -> str:
    ...
    high_keys = {
        ...
        "why_user_missed_clearance_then_check",
        "why_user_missed_attack_with_tempo",
        "why_user_missed_attack_with_tempo_full",
        "why_user_missed_queen_fork",
        "why_user_missed_queen_capture_with_check",
        "why_user_missed_endgame_pawn_grab",
        "why_user_missed_endgame_pawn_attack",
        "why_user_un_developing",
        "why_user_defensive_pawn_push",
        "why_user_missed_knight_outpost",
        "why_user_missed_stop_opp_pawn",

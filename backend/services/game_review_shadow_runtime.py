...
deriver and adapts the exact ``MoveTeachingDecision`` produced by V5. Only the
current-schema, Plan-authorized ``simple_hang`` signal can enter the shadow
planner; every other observation remains silent until separately promoted.
"""

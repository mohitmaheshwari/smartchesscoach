...
def get_opening_introduction(
    ...
    _CONTEXT_OVERRIDES = {
        ...
        ("d5", "e4"): {
            ...
            "idea": "Black challenges the center immediately. Trades the d-pawn but draws White's queen out — Black then attacks it with tempo.",
        },
    }
    if (
        move_index == 1

...
V5_COACHING_VERSION = 112  # v112 (2026-06-07): disabled opp-failure V3 - verification showed it fired on material-drops (already covered), not active-for-inactive trades. v111 (V3 wiring, reverted). v110 floor-principle + overrides.

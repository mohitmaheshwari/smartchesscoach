...
V5_COACHING_VERSION = 150  # v150 (2026-09-10): selected review moments may reuse immutable candidate evidence to compare the played human-likely idea with one verified stronger line. Read paths stay stored-only; writing is separately gated during analysis/backfill; visible projection is separately gated and fail-closed. v149 (2026-09-09): opponent alternatives can now explain a legally proved capture-recapture-pawn-fork resolution instead of stopping at the misleading immediate capture.
